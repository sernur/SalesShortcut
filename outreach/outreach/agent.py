...
from .tools.phone_call import phone_call_function_tool, phone_number_validation_callback, phone_call_test_function_tool
from .tools.message_email import message_email_function_tool, message_email_test_function_tool
...
outreach_agent = LlmAgent(
    ...
    tools=[phone_call_test_function_tool, message_email_test_function_tool],
